...
module.exports = function (message) {
    ...
    var groups = gatherTypesAndContainers(data, result)
 ...
 * Each key will be an array of msg.data. Any `containers` data found will
 * be attached to result
 *
 * @param {Object} data
 * @param {Object} result The final result object to modify
 *
 ...
 */
var gatherTypesAndContainers = function (data, result) {
    var groups = {},
        str = ''
